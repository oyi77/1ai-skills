---
name: stripe-mcp
description: Use when mCP server for Stripe payments. Process payments, manage subscriptions,
  and handle billing via standardized protocol. Use when working with stripe mcp.
domain: mcp
author: oyi77
license: Apache-2.0
subdomain: mcp
