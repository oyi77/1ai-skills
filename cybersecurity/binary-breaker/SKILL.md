...
Cybersecurity skill for binary breaker. Follows industry best practices and security standards.
...
1. **Execute** — Run binary breaker workflow with configured parameters
