...
description: Use when detect and prevent privilege escalation in Kubernetes pods by
  monitoring security contexts, capabilities, and syscall patterns with Falco and
  OPA policies. Use when detecting and prevent privilege escalation in kubernetes
  pods by monitoring.
...
This section covers detection with admission control for detecting privilege escalation in kubernetes pods.
