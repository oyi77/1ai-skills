...
def load_intelligence_requirements(filepath: str) -> list[dict]:
    ...
    return [
        {
            "id": "PIR-001",
            "requirement": "Which threat actors are actively targeting our industry sector?",
            "stakeholder": "CISO",
            "priority": "HIGH",
            "status": "active",
        ...
        {
            "id": "PIR-002",
            "requirement": "What new vulnerabilities affect our technology stack?",
        ...
        {
            "id": "PIR-003",
            "requirement": "Are any of our credentials or data exposed on dark web?",
            "stakeholder": "CISO",
            "priority": "MEDIUM",
            "status": "active",
            "review_date": "2024-06-01",
...
def evaluate_collection_sources(sources_file: str) -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "pirs_covered": ["PIR-001", "PIR-002", "PIR-003"],
        },
        {
            "name": "VirusTotal",
            "type": "commercial",
        ...
        {
            "name": "ISAC Feeds",
            "type": "sharing-community",
            "category": "sector-specific",
            "reliability": "B",
            "update_freq": "weekly",
            "pirs_covered": ["PIR-001", "PIR-002"],
        },
    ]
...
def assess_pir_coverage(pirs: list[dict], sources: list[dict]) -> dict:
    ...
    for pir in pirs:
        pir_id = pir["id"]
        covering_sources = [
            s["name"] for s in sources if pir_id in s.get("pirs_covered", [])
        ]
        coverage[pir_id] = {
        ...
        "maturity_level": (
            ...
            if overall < 2
                ...
                if overall < 3
                    ...
                    "Defined"
                    if overall < 4
                    else "Managed" if overall < 4.5 else "Optimizing"
                )
            )
        ),
    }
