...
description: Use when tests API rate limiting implementations for bypass vulnerabilities
  by manipulating request headers, IP addresses, HTTP methods, API versions, and encoding
  ...
  to OWASP API4:2023 Unrestricted Resource Consumption.
