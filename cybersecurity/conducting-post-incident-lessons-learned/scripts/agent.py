...
def calculate_metrics(incident_data):
    ...
    if contain_time and detect_time:
        metrics["mttc_minutes"] = round(
            (contain_time - detect_time).total_seconds() / 60
        )
    if resolve_time and detect_time:
        metrics["mttr_minutes"] = round(
            (resolve_time - detect_time).total_seconds() / 60
        )
    return metrics
        ...
        "sections": [
            {
                ...
                "content": "Brief overview of incident and impact",
            },
            {
            ...
            },
            {
                ...
                "content": "Underlying cause identification",
            },
            {"title": "What Went Well", "content": "Effective response actions"},
            {
                "title": "What Needs Improvement",
                "content": "Gaps and failures identified",
            },
            {
                "title": "Action Items",
            ...
            {
                "title": "Appendix",
                "content": "Supporting evidence, IOCs, detection rules",
            },
        ],
    }
