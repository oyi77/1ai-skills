...
description: Use when deploy and configure the Dragos Platform for OT network monitoring,
  ...
  threat groups like VOLTZITE, GRAPHITE, and BAUXITE. . Use when working with implementing
