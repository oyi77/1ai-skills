...
WINDOWS_PRIVESC_PATTERNS = [
    (
        r"eventvwr\.exe|fodhelper\.exe|computerdefaults\.exe",
        "T1548.002",
        "CRITICAL",
        "UAC Bypass",
    ),
    ...
    (
        r"sc\s+(config|create).*binpath",
        "T1543.003",
        "HIGH",
        "Service binary modification",
    ),
    (
        r"potato.*exploit|juicypotato|sweetpotato|godpotato",
        "T1134.001",
        "CRITICAL",
...
LINUX_PRIVESC_PATTERNS = [
    ...
    (
        r"find.*-perm.*4000|find.*-perm.*/u=s",
        "T1548.001",
        "MEDIUM",
        "SUID binary search",
    ),
