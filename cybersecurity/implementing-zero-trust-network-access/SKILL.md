...
description: Use when implementing Zero Trust Network Access (ZTNA) in cloud environments
  ...
  BeyondCorp-style architectures across AWS, Azure, and GCP. . Use when working with
