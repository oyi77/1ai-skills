...
description: Use when systematically audit AWS S3 bucket permissions to identify publicly
  ...
  data access controls. . Use when working with auditing aws s3 bucket permissions.
