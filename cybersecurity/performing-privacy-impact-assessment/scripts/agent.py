...
GDPR_ADEQUATE_COUNTRIES = {
    ...
    "GB",
    "UY",
    "US",  # US under EU-US Data Privacy Framework
...
GDPR_DPIA_ARTICLES = {
    "5": {
        ...
        "checks": [
            {
                "id": "5.1a",
                "desc": "Lawfulness, fairness and transparency",
                "field": "legal_basis",
                "required": True,
            },
            {
                "id": "5.1b",
                "desc": "Purpose limitation",
                "field": "purpose_specified",
                "required": True,
            },
            {
                "id": "5.1c",
                "desc": "Data minimization",
                "field": "data_minimization_justified",
                "required": True,
            },
            {
                "id": "5.1d",
                "desc": "Accuracy of data",
                "field": "accuracy_measures",
                "required": True,
            },
            {
                "id": "5.1e",
                "desc": "Storage limitation",
                "field": "retention_period_days",
                "required": True,
            },
            {
                "id": "5.1f",
                "desc": "Integrity and confidentiality",
    ...
    "6": {
        ...
        "checks": [
            {
                "id": "6.1",
                "desc": "Valid legal basis identified",
                "field": "legal_basis",
                "valid_values": [
                    "consent",
                    "contract",
    ...
    "7": {
        ...
        "checks": [
            {
                "id": "7.1",
                "desc": "Demonstrable consent obtained",
                "field": "consent_mechanism",
                "condition_field": "legal_basis",
                "condition_value": "consent",
            },
            {
                "id": "7.3",
                "desc": "Right to withdraw consent",
                "field": "consent_withdrawal_mechanism",
                "condition_field": "legal_basis",
                "condition_value": "consent",
            },
        ],
    ...
    "13": {
        ...
        "checks": [
            {
                "id": "13.1",
                "desc": "Privacy notice provided at collection",
    ...
    "22": {
        ...
        "checks": [
            {
                "id": "22.1",
                "desc": "Right not to be subject to automated decision",
                "field": "human_oversight",
                "condition_field": "automated_decision_making",
                "condition_value": True,
            },
            {
                "id": "22.3",
                "desc": "Right to contest automated decision",
                "field": "appeal_mechanism",
                "condition_field": "automated_decision_making",
                "condition_value": True,
            },
        ],
    ...
    "25": {
        ...
        "checks": [
            {
                "id": "25.1",
                "desc": "Privacy by design measures implemented",
                "field": "privacy_by_design",
                "required": True,
            },
            {
                "id": "25.2",
                "desc": "Data protection by default",
                "field": "data_protection_defaults",
                "required": True,
            },
        ],
    },
    "28": {
        ...
        "checks": [
            {
                "id": "28.3",
                "desc": "Data processing agreement with processor",
                "field": "data_processing_agreement",
                "condition_field": "data_processor",
    ...
    "32": {
        ...
        "checks": [
            {
                "id": "32.1",
                "desc": "Appropriate technical and organizational measures",
                "field": "security_measures",
                "required": True,
            },
        ],
    ...
    "33": {
        ...
        "checks": [
            {
                "id": "33.1",
                "desc": "Breach notification within 72 hours capability",
                "field": "breach_notification_plan",
                "required": True,
            },
        ],
    },
    "35": {
        ...
        "checks": [
            {
                "id": "35.7a",
                "desc": "Systematic description of processing",
                "field": "processing_description",
                "required": True,
            },
            {
                "id": "35.7b",
                "desc": "Necessity and proportionality assessment",
                "field": "necessity_assessment",
                "required": True,
            },
            {
                "id": "35.7c",
                "desc": "Risks to rights and freedoms assessment",
                "field": "risk_assessment_completed",
                "required": True,
            },
            {
                "id": "35.7d",
                "desc": "Measures to address risks",
                "field": "risk_mitigation_measures",
                "required": True,
            },
        ],
    },
    "44": {
        ...
        "checks": [
            {
                "id": "44.1",
                "desc": "Transfer safeguards for cross-border data",
                "field": "transfer_safeguards",
                "condition_field": "cross_border_transfer",
                "condition_value": True,
            },
        ],
    },
...
CCPA_SECTIONS = {
    "1798.100": {
        ...
        "checks": [
            {
                "id": "100.a",
                "desc": "Right to know what PI is collected",
                "field": "data_inventory_available",
                "required": True,
            },
            {
                "id": "100.b",
                "desc": "Disclosure of categories of PI collected",
                "field": "categories_disclosed",
                "required": True,
            },
        ],
    },
    "1798.105": {
        ...
        "checks": [
            {
                "id": "105.a",
                "desc": "Right to request deletion of PI",
                "field": "deletion_mechanism",
                "required": True,
            },
        ],
    },
    "1798.106": {
        ...
        "checks": [
            {
                "id": "106.a",
                "desc": "Right to correct inaccurate PI",
                "field": "correction_mechanism",
                "required": True,
            },
        ],
    },
    "1798.110": {
        ...
        "checks": [
            {
                "id": "110.a",
                "desc": "Disclose categories, sources, purposes, third parties",
                "field": "data_inventory_available",
                "required": True,
            },
        ],
    ...
    "1798.115": {
        ...
        "checks": [
            {
                "id": "115.a",
                "desc": "Disclosure of selling or sharing of PI",
                "field": "selling_sharing_disclosed",
                "required": True,
            },
        ],
    },
    "1798.120": {
        ...
        "checks": [
            {
                "id": "120.a",
                "desc": "Do Not Sell or Share opt-out mechanism",
                "field": "opt_out_mechanism",
                "condition_field": "sells_or_shares_data",
                "condition_value": True,
            },
        ],
    },
    "1798.121": {
        ...
        "checks": [
            {
                "id": "121.a",
                "desc": "Limit use and disclosure of sensitive PI",
                "field": "sensitive_data_controls",
                "condition_field": "_has_sensitive_data",
                "condition_value": True,
            },
        ],
    },
    "1798.125": {
        ...
        "checks": [
            {
                "id": "125.a",
                "desc": "No discrimination for exercising rights",
                "field": "non_discrimination_policy",
                "required": True,
            },
        ],
    },
    "1798.130": {
        ...
        "checks": [
            {
                "id": "130.a",
                "desc": "Methods for submitting consumer requests",
                "field": "request_submission_methods",
                "required": True,
            },
            {
                "id": "130.a.2",
                "desc": "Respond to requests within 45 days",
                "field": "response_sla_days",
                "required": True,
                "max_value": 45,
            },
        ],
    ...
    "1798.135": {
        ...
        "checks": [
            {
                "id": "135.a",
                "desc": "Clear and conspicuous opt-out link on homepage",
                "field": "opt_out_link_on_homepage",
                "condition_field": "sells_or_shares_data",
                "condition_value": True,
            },
        ],
    ...
    "1798.185": {
        ...
        "checks": [
            {
                "id": "185.a.15",
                "desc": "Risk assessment for significant processing",
                "field": "risk_assessment_completed",
                "required": True,
            },
        ],
        ...
        "categories": {
            "ID.IM-P": {
                ...
                "subcategories": [
                    {
                        "id": "ID.IM-P1",
                        "desc": "Systems and assets that process data are inventoried",
                        "check": "data_inventory_available",
                    },
                    {
                        "id": "ID.IM-P2",
                        "desc": "Data actions mapped to system operations",
                        "check": "data_flow_mapped",
                    },
                    {
                        "id": "ID.IM-P3",
                        "desc": "Data elements mapped within data actions",
                        "check": "data_elements_mapped",
                    },
                    {
                        "id": "ID.IM-P4",
                        "desc": "Data actions of service providers identified",
                        "check": "processor_actions_identified",
                    },
                    {
                        "id": "ID.IM-P5",
                        "desc": "Affected individuals identified",
                        "check": "data_subjects_identified",
                    },
                    {
                        "id": "ID.IM-P6",
                        "desc": "Data processing purposes identified",
                        "check": "purpose_specified",
                    },
                    {
                        "id": "ID.IM-P7",
                        "desc": "Legal authorities for data actions identified",
                        "check": "legal_basis",
                    },
                    {
                        "id": "ID.IM-P8",
                        "desc": "Problematic data actions assessed",
            ...
            "ID.BE-P": {
                ...
                "subcategories": [
                    {
                        "id": "ID.BE-P1",
                        "desc": "Privacy values and policies established",
                        "check": "privacy_policy_established",
                    },
                    {
                        "id": "ID.BE-P2",
                        "desc": "Privacy role in enterprise risk management",
            ...
            "ID.RA-P": {
                ...
                "subcategories": [
                    {
                        "id": "ID.RA-P1",
                        "desc": "Contextual factors related to data processing identified",
                        "check": "contextual_factors_documented",
                    },
                    {
                        "id": "ID.RA-P2",
                        "desc": "Data analytic inputs and outputs identified",
                        "check": "analytics_io_documented",
                    },
                    {
                        "id": "ID.RA-P3",
                        "desc": "Potential problematic data actions assessed",
                        "check": "risk_assessment_completed",
                    },
                    {
                        "id": "ID.RA-P4",
                        "desc": "Problematic data actions prioritized",
                        "check": "risks_prioritized",
                    },
                    {
                        "id": "ID.RA-P5",
                        "desc": "Risk responses identified and prioritized",
        ...
        "categories": {
            "GV.PO-P": {
                ...
                "subcategories": [
                    {
                        "id": "GV.PO-P1",
                        "desc": "Organizational privacy policy established",
                        "check": "privacy_policy_established",
                    },
                    {
                        "id": "GV.PO-P2",
                        "desc": "Privacy risk management processes established",
                        "check": "risk_management_process",
                    },
                    {
                        "id": "GV.PO-P3",
                        "desc": "Roles and responsibilities defined",
                        "check": "privacy_roles_defined",
                    },
                    {
                        "id": "GV.PO-P4",
                        "desc": "Governance and risk management reviewed",
                        "check": "governance_reviewed",
                    },
                    {
                        "id": "GV.PO-P5",
                        "desc": "Legal requirements identified",
                        "check": "legal_requirements_identified",
                    },
                    {
                        "id": "GV.PO-P6",
                        "desc": "Governance structure includes privacy",
            ...
            "GV.AT-P": {
                ...
                "subcategories": [
                    {
                        "id": "GV.AT-P1",
                        "desc": "Workforce informed of privacy policies",
                        "check": "privacy_training",
                    },
                    {
                        "id": "GV.AT-P2",
                        "desc": "Senior executives understand privacy risk",
                        "check": "executive_awareness",
                    },
                    {
                        "id": "GV.AT-P3",
                        "desc": "Privacy personnel understand responsibilities",
                        "check": "privacy_team_trained",
                    },
                    {
                        "id": "GV.AT-P4",
                        "desc": "Third parties understand privacy obligations",
            ...
            "GV.MT-P": {
                ...
                "subcategories": [
                    {
                        "id": "GV.MT-P1",
                        "desc": "Privacy risk re-assessed on ongoing basis",
                        "check": "ongoing_reassessment",
                    },
                    {
                        "id": "GV.MT-P2",
                        "desc": "Privacy values reflected in practices",
                        "check": "privacy_values_in_practice",
                    },
                    {
                        "id": "GV.MT-P3",
                        "desc": "Policies updated to reflect changes",
        ...
        "categories": {
            "CT.DM-P": {
                ...
                "subcategories": [
                    {
                        "id": "CT.DM-P1",
                        "desc": "Data elements managed consistent with risk strategy",
                        "check": "data_management_aligned",
                    },
                    {
                        "id": "CT.DM-P2",
                        "desc": "Data retention and disposal policy",
                        "check": "retention_policy",
                    },
                    {
                        "id": "CT.DM-P3",
                        "desc": "Data processing accuracy maintained",
                        "check": "accuracy_measures",
                    },
                    {
                        "id": "CT.DM-P4",
                        "desc": "Data disclosed only as authorized",
                        "check": "disclosure_controls",
                    },
                    {
                        "id": "CT.DM-P5",
                        "desc": "Data from processing manipulations managed",
                        "check": "derived_data_managed",
                    },
                    {
                        "id": "CT.DM-P6",
                        "desc": "Data in transit managed",
                        "check": "transit_controls",
                    },
                    {
                        "id": "CT.DM-P7",
                        "desc": "Mechanisms for transmitting consent preferences",
                        "check": "consent_preference_mechanism",
                    },
                    {
                        "id": "CT.DM-P8",
                        "desc": "Audit/log records for data processing",
                        "check": "processing_audit_log",
                    },
                    {
                        "id": "CT.DM-P9",
                        "desc": "Technical measures for consent management",
                        "check": "consent_management_system",
                    },
                    {
                        "id": "CT.DM-P10",
                        "desc": "Data quality maintained through lifecycle",
            ...
            "CT.PO-P": {
                ...
                "subcategories": [
                    {
                        "id": "CT.PO-P1",
                        "desc": "De-identification policies and processes",
                        "check": "deidentification_policy",
                    },
                    {
                        "id": "CT.PO-P2",
                        "desc": "Data tagging for purpose and provenance",
                        "check": "data_tagging",
                    },
                    {
                        "id": "CT.PO-P3",
                        "desc": "Administrative access safeguards",
                        "check": "admin_access_controls",
                    },
                    {
                        "id": "CT.PO-P4",
                        "desc": "System monitoring for privacy compliance",
        ...
        "categories": {
            "CM.AW-P": {
                ...
                "subcategories": [
                    {
                        "id": "CM.AW-P1",
                        "desc": "Privacy practices communicated to individuals",
                        "check": "privacy_notice",
                    },
                    {
                        "id": "CM.AW-P2",
                        "desc": "Mechanisms for individual complaints",
                        "check": "complaint_mechanism",
                    },
                    {
                        "id": "CM.AW-P3",
                        "desc": "System changes communicated",
                        "check": "change_notification",
                    },
                    {
                        "id": "CM.AW-P4",
                        "desc": "Data processing awareness program",
        ...
        "categories": {
            "PR.AC-P": {
                ...
                "subcategories": [
                    ...
                    {
                        "id": "PR.AC-P2",
                        "desc": "Physical access managed",
                        "check": "physical_access_controls",
                    },
                    {
                        "id": "PR.AC-P3",
                        "desc": "Remote access managed",
                    ...
                    {
                        "id": "PR.AC-P5",
                        "desc": "Network integrity protected",
                        "check": "network_integrity",
                    },
                    {
                        "id": "PR.AC-P6",
                        "desc": "Individuals authenticated",
            ...
            "PR.DS-P": {
                ...
                "subcategories": [
                    ...
                    {
                        "id": "PR.DS-P3",
                        "desc": "Systems and data formally managed",
                        "check": "asset_management",
                    },
                    {
                        "id": "PR.DS-P4",
                        "desc": "Adequate capacity maintained",
                        "check": "capacity_management",
                    },
                    {
                        "id": "PR.DS-P5",
                        "desc": "Protections against data leaks implemented",
                        "check": "dlp_controls",
                    },
                    {
                        "id": "PR.DS-P6",
                        "desc": "Integrity checking mechanisms used",
                        "check": "integrity_checking",
                    },
                    {
                        "id": "PR.DS-P7",
                        "desc": "Development and testing use non-production data",
                        "check": "non_production_data",
                    },
                    {
                        "id": "PR.DS-P8",
                        "desc": "Hardware integrity verified",
            ...
            "PR.PO-P": {
                ...
                "subcategories": [
                    {
                        "id": "PR.PO-P1",
                        "desc": "Baseline configuration maintained",
                        "check": "baseline_config",
                    },
                    {
                        "id": "PR.PO-P2",
                        "desc": "Configuration change control in place",
                        "check": "change_control",
                    },
                    {
                        "id": "PR.PO-P3",
                        "desc": "Backups maintained and tested",
                        "check": "backup_tested",
                    },
                    {
                        "id": "PR.PO-P4",
                        "desc": "Response and recovery plans tested",
                        "check": "incident_response_tested",
                    },
                    {
                        "id": "PR.PO-P5",
                        "desc": "Improvements implemented from testing",
                        "check": "continuous_improvement",
                    },
                    {
                        "id": "PR.PO-P6",
                        "desc": "Data disposal performed",
                        "check": "data_disposal",
                    },
                    {
                        "id": "PR.PO-P7",
                        "desc": "Protection processes improved",
                        "check": "protection_improvement",
                    },
                    {
                        "id": "PR.PO-P8",
                        "desc": "Protection technology shared",
                        "check": "protection_shared",
                    },
                    {
                        "id": "PR.PO-P9",
                        "desc": "Response plans managed",
                        "check": "response_plans",
                    },
                    {
                        "id": "PR.PO-P10",
                        "desc": "Protection updated with testing results",
...
PRIVACY_RISK_RULES = [
    {
        ...
        "check": lambda a: len(a.get("data_categories", [])) > 5
        and not a.get("data_minimization_justified"),
        "likelihood_base": 4,
        "impact_base": 3,
    ...
    },
    {
        ...
        "check": lambda a: not a.get("purpose_specified")
        or a.get("secondary_purposes"),
        "likelihood_base": 3,
        "impact_base": 4,
    ...
    },
    {
        ...
        "check": lambda a: a.get("cross_border_transfer")
        and any(
    ...
    },
    {
        ...
        "check": lambda a: a.get("automated_decision_making")
        and not a.get("human_oversight"),
        "likelihood_base": 4,
        "impact_base": 5,
    ...
    },
    {
        ...
        "check": lambda a: a.get("data_processor")
        and not a.get("data_processing_agreement"),
        "likelihood_base": 3,
        "impact_base": 4,
    ...
    },
    {
        ...
        "check": lambda a: not a.get("encryption_at_rest")
        or not a.get("encryption_in_transit"),
        "likelihood_base": 4,
        "impact_base": 5,
    ...
    },
    {
        ...
        "check": lambda a: not a.get("retention_period_days")
        or a.get("retention_period_days", 0) > 1095,
        "likelihood_base": 3,
        "impact_base": 3,
    ...
    },
    {
        ...
        "check": lambda a: a.get("legal_basis") == "consent"
        and not a.get("consent_mechanism"),
        "likelihood_base": 4,
        "impact_base": 4,
    ...
    },
    {
        ...
        and a.get("legal_basis") != "explicit_consent"
        and not a.get("art9_exemption"),
        "likelihood_base": 3,
        "impact_base": 5,
...
class PrivacyImpactAssessmentEngine:
    ...
    def register_processing_activity(
        ...
        **kwargs,
        ...
        for cat in activity["data_categories"]:
            ...
            elif info["sensitivity"] == "high" and max_sensitivity not in (
                "special_category",
            ):
    ...
    def map_data_flows(self, activity_id, flows):
        ...
        for i, flow in enumerate(flows):
            flow_entry = {
                ...
                "data_processing_agreement": flow.get(
            ...
            if flow_entry["stage"] in ("processing", "storage", "sharing"):
                if (
                    not flow_entry["encryption_in_transit"]
                    and flow_entry["stage"] != "storage"
                ):
                ...
                if (
                    not flow_entry["encryption_at_rest"]
                    and flow_entry["stage"] == "storage"
                ):
                    flow_map["flow_summary"]["encryption_gaps"].append(
                        {
    ...
    def run_screening_checklist(
        ...
        dpia_required = len(triggers) >= 2 or bool(set(triggers) & high_impact_single)
    ...
    def check_ccpa_compliance(self, activity_id):
        ...
        # Derive helper flags
        has_sensitive = any(
            DATA_SENSITIVITY.get(cat, {}).get("sensitivity")
            in ("special_category", "high")
    ...
    def generate_nist_privacy_profile(self, activity_id, target_tier="tier_2"):
        ...
        profile["coverage"] = {
            ...
            "coverage_percentage": (
                round((implemented / total_subcats) * 100, 1) if total_subcats else 0
            ),
        }
    ...
    def generate_remediation_plan(
        self, activity_id, risk_report=None, gdpr_report=None, ccpa_report=None
    ):
                ...
                action_items.append(
                    {
                        ...
                        "owner": "Privacy Team",
                        "deadline": (
                            now + timedelta(days=deadline_days.get(sev, 90))
                        ).strftime("%Y-%m-%d"),
                        "status": "open",
                    }
                )
    ...
    def generate_dpia_report(
        self, activity_id, output_path="dpia_report.json", format="json"
    ):
        ...
        report = {
            ...
            "review_schedule": {
                "next_review": (datetime.utcnow() + timedelta(days=365)).strftime(
                    "%Y-%m-%d"
                ),
...
def main():
    ...
    parser.add_argument(
        "--output", default="pia_report.json", help="Output report path"
    )
    parser.add_argument(
        "--action",
        choices=[
    ...
    if args.action == "screening":
            ...
            flows=[
                {
                    ...
                    "data_elements": ["ip_address", "device_id"],
                ...
                },
                {
                    ...
                    "destination": "ML Provider (IN)",
                    "data_elements": ["browsing_history"],
                    "encryption_in_transit": True,
                    "cross_border": True,
        ...
        for risk in risk_report["risks"][:5]:
            print(
                f"    [{risk['severity']}] {risk['category']}: Score {risk['risk_score']}/25"
            )
        ...
        print(
            f"[!] Action '{args.action}' requires an activity to be registered first."
        )
