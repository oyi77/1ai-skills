...
3. **Build Detection Queries** — Write spearphishing indicators queries targeting  indicators. Use platform-specific query language for optimal performance.
...
- **spearphishing indicators** — Primary tool for this skill
