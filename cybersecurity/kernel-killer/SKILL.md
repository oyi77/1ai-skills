...
Cybersecurity skill for kernel killer. Follows industry best practices and security standards.
...
1. **Execute** — Run kernel killer workflow with configured parameters
