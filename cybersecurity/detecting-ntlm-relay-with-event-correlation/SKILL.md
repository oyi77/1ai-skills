...
description: Use when detect NTLM relay attacks through Windows Security Event correlation
  ...
  . Use when working with detecting ntlm relay with event correlation.
