...
description: Use when this skill covers implementing Gitleaks for detecting and preventing
...
1. **Execute** — Run implementing secret scanning with gitleaks workflow with configured parameters
