...
description: Use when implementing Cloud Security Posture Management (CSPM) to continuously
  ...
  GCP Security Command Center. . Use when working with implementing cloud security
  posture management.
