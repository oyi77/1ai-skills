...
def parse_bench_output(output):
    ...
    for line in output.split("\n"):
        ...
        if (
            ...
            and "- " in line
            and any(c.isdigit() for c in line[:20])
        ):
            ...
            findings.append(
                {
                    ...
                    "message": line.replace("[WARN]", "").strip(),
                }
            )
            ...
            findings.append(
                {
                    "level": "PASS",
                    "section": current_section,
                    "message": line.replace("[PASS]", "").strip(),
                }
            )
        ...
        issues.append(
            {
                "severity": "HIGH",
                "check": "5.13",
                "finding": "Container shares host network namespace",
            }
        )
        ...
        issues.append(
            {
                "severity": "HIGH",
                "check": "5.3",
                "finding": f"Dangerous capabilities added: {added_dangerous}",
            }
        )
            ...
            issues.append(
                {
                    "severity": "HIGH",
                    "check": "5.5",
                    "finding": f"Sensitive host path mounted: {src}",
                }
            )
    return issues
