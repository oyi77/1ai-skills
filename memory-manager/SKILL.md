...
## Vector Memory Hygiene (LanceDB)

If your agent uses LanceDB vector memory, apply these hygiene rules:

**Disable auto-capture** (main source of junk):
```json
{
  "plugins": {
    "entries": {
...
**Storage guidelines:**
- Keep text concise (<100 words per entry)
- Use appropriate category
- Set importance 0.7-1.0 for valuable info
- One concept per memory entry

**Monthly maintenance:** Wipe `~/.clawdbot/memory/lancedb/`, reseed key facts from MEMORY.md, restart gateway.
