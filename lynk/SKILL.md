...
- **Dashboard URL:** https://lynk.id/dashboard
...
3. Get redirected to https://lynk.id/dashboard
...
browser navigate {targetId} https://lynk.id/dashboard
...
**Solutions:**
1. Login to LYNK dashboard: https://lynk.id/dashboard
