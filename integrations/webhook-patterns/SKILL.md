...
description: Use when webhook design and handling — signature verification, retry
  logic, idempotency, event routing, testing. Use when working with webhook patterns.
domain: integrations
author: oyi77
license: Apache-2.0
