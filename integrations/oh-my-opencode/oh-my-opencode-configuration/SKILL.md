...
description: Use when comprehensive configuration guide for oh-my-opencode including
  agent settings, MCP servers, hooks, categories, and advanced options. Use when working
  with oh my opencode configuration.
domain: integrations
author: oyi77
license: Apache-2.0
