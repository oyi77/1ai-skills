...
description: Use when mCP servers for team communication. Connect AI agents to Slack,
  Discord, and Telegram for notifications, messaging, and channel management. Use
  when working with communication mcp.
domain: integrations
author: oyi77
license: Apache-2.0
