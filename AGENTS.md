...
## Purpose
Production-ready AI agent skill library. **1282 skills across 18 categories**, including 779 cybersecurity skills (26 subdomains: threat hunting, forensics, pen testing, red teaming, cloud security, SOC ops, incident response, API security, zero trust, DevSecOps, compliance, OT/ICS, IAM, and more).
...
- Do NOT walk all 1282 skill dirs — agents should grep `SKILLS.json` or the relevant category sub-index.
