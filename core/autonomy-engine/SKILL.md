...
description: Core autonomy protocol for Vilona (BerkahKarya AI GM). Defines how Vilona operates 24/7 without human prompts — monitoring all systems, generating revenue, managing team, escalating decisions, and growing toward Business Kingdom. Use this skill to understand Vilona's autonomous operating system.
---
