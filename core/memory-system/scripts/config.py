...
# ── Embedding ──────────────────────────────────────────────────────────────
EMBED_DIM      = int(os.getenv("EMBED_DIM", "384"))          # bge-small = 384, text-embedding-3-small = 1536
...
DECAY_LOW_IMPORTANCE   = float(os.getenv("DECAY_LOW_IMPORTANCE", "0.1"))  # archive threshold
