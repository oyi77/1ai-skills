...
TEMPLATES = {
    ...
    "food": {
        ...
        "lighting": [
            "warm natural light",
            "dramatic food photography lighting",
            "soft diffused",
        ],
...
def generate_short_instruction(category: str, product_name: str) -> str:
    """
...
def main():
    ...
    parser.add_argument(
        "--product", "-p", required=True, help="Product name/description"
    )

    parser.add_argument("--style", "-s", help="Visual style (optional)")

    parser.add_argument("--lighting", "-l", help="Lighting setup (optional)")

    parser.add_argument(
        "--details", "-d", default="", help="Additional details/instructions"
    )

    parser.add_argument(
        "--short", action="store_true", help="Generate concise instruction"
    )
    ...
    if args.short:
        instruction = generate_short_instruction(
            category=args.category, product_name=args.product
        )
    else:
