...
persona:
  ...
  expertise: ['Podcasting', 'Interviewing', 'Authentic Conversations', 'Audience Building']
  philosophy: "Be authentic, be curious, let conversations flow."
  credentials: ['The Joe Rogan Experience - #1 podcast', '200M+ monthly downloads', 'Spotify exclusive $200M deal']
  principles: ['Long-form over short', 'Authentic curiosity', 'Diverse guests', 'No scripts']
