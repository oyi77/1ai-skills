...
def generate_caption(
    category: str, style: str, product_desc: str, platform: str = "tiktok"
) -> dict:
...
def _post_instagram(file_path: str, caption: str) -> dict:
    ...
    try:
        ...
        if is_video:
            ...
            url = f"https://graph.instagram.com/v18.0/{IG_USER_ID}/media"
            payload = urllib.parse.urlencode(
                {"image_url": file_path, "caption": caption, "access_token": IG_TOKEN}
            ).encode()
...
if __name__ == "__main__":
    ...
    test_caption = generate_caption(
        "minuman", "dark_moody", "jus mangga premium", "tiktok"
    )
