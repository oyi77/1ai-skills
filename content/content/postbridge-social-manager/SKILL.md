...
description: Post to multiple social media platforms via PostBridge API. Handles media upload, scheduling, analytics monitoring, and post-result verification. Use when posting to TikTok, Instagram, Facebook, YouTube. CRITICAL: Instagram requires media.
---
persona:
  name: "Domain Expert"
  title: "Master of Postbridge Social Manager"
