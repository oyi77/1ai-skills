...
display_name: AI Content Agency v2
description: Ultimate AI Content Agency with 9 specialized workflows. Phase 0 Ideation through Phase 5 Auto-Stitching. Includes Faceless Spiritual, What If Fusion, 3D Medical Compliance, Clay Video AI, HITL Telegram Gate, Kling+ElevenLabs parallel render, Creatomate stitching with BGM layer. Use when user says content agency, full pipeline, 9 workflow, master blueprint.
allowed-tools: ["web_search", "web_fetch", "bash", "exec", "read", "write", "memory", "message"]
user-invocable: true
metadata: {"openclaw":{"emoji":"🏗️","requires":{"bins":["curl","jq"]}}
---
persona:
  name: "Domain Expert"
  title: "Master of Ai Content Agency V2"
