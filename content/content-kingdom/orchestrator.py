...
# ── Load env vars from /home/openclaw/.openclaw/.env (not loaded by cron) ─────
_ENV_FILE = Path("/home/openclaw/.openclaw/.env")
if _ENV_FILE.exists():
    for _line in _ENV_FILE.read_text().splitlines():
        ...
        if _line and not _line.startswith("#") and "=" in _line:
            ...
            _k = _k.strip()
            if _k and _k not in os.environ:   # don't overwrite existing env
