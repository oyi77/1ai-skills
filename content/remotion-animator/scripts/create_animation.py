...
TEMPLATES = {
    ...
    "data_viz": {
        ...
        "params": {
            "animation": {
                "default": "counter",
                "options": ["counter", "bar-chart-growth", "progress-bar", "pie-chart"],
            },
    ...
    "logo_reveal": {
        ...
        "params": {
            ...
            "animation": {
                "default": "path-draw",
                "options": ["path-draw", "scale-fade", "rotate-in", "glow-effect"],
            },
            "duration": {"default": 5, "type": "int"},
    ...
    "social_post": {
        ...
        "params": {
            "platform": {
                "required": True,
                "options": ["tiktok", "reels", "youtube-shorts"],
            },
            "template": {
                "default": "tiktok-intro",
                "options": ["tiktok-intro", "reels-hook", "youtube-shorts"],
            },
            "text": {"required": True, "type": "str"},
            "duration": {"default": 3, "type": "int"},
        },
