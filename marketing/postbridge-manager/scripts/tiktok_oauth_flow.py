...
# client_key: aw75i85tzolnpqso (PostBridge TikTok app)
...
def cmd_get_url(mode='connect'):
    ...
    print('https://www.tiktok.com/login?lang=en&enter_from=dev_aw75i85tzolnpqso')
    ...
    print('client_key: aw75i85tzolnpqso')
