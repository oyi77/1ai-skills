---
name: wails-apps
description: Use when wails desktop app development — Go backend, web frontend, native
  bindings, small binary, cross-platform. Use when working with wails apps.
domain: development
author: oyi77
license: Apache-2.0
