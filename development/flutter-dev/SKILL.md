---
name: flutter-dev
description: Use when flutter cross-platform development — Dart, widgets, state management,
  platform channels, Firebase integration. Use when working with flutter dev.
domain: development
author: oyi77
license: Apache-2.0
