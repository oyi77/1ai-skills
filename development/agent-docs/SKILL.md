...
persona:
  name: "Domain Expert"
  title: "Master of Agent Docs"
  expertise: ['Development Excellence', 'Best Practices', 'Professional Standards']
...
- DB: `docs/db/schema.md`"># AGENTS.md
> Context: Next.js 16 | Tailwind | Supabase
...
- [Schema](docs/db/schema.md): Full Prisma schema">">Location: /llms.txt at domain root
...
For detailed guidance on RAG optimization, multi-framework docs, and API templates, see [references/advanced-patterns.md](/openclaw/skills/blob/main/skills/tylervovan/agent-docs/references/advanced-patterns.md).
