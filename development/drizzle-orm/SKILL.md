---
name: drizzle-orm
description: Use when drizzle ORM — type-safe SQL, schema definitions, migrations,
  queries, relations for TypeScript/Node.js. Use when working with drizzle orm.
domain: development
author: oyi77
license: Apache-2.0
