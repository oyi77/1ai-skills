...
description: Use when react Native with Expo — managed workflow, native modules, navigation,
  and app store deployment. Use when working with react native expo.
domain: development
author: oyi77
license: Apache-2.0
