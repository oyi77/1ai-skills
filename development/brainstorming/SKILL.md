---
name: brainstorming
description: Use when effective brainstorming skill for features and projects. Clarify
  intent, explore options, and guide design decisions to align with user goals. Use
  when working with brainstorming.
domain: development
author: oyi77
license: Apache-2.0
