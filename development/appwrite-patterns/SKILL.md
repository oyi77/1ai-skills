...
description: Use when appwrite backend-as-a-service — auth, database, storage, functions,
  realtime for web/mobile/desktop. Use when working with appwrite patterns.
domain: development
author: oyi77
license: Apache-2.0
