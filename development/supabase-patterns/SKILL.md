...
description: Use when supabase patterns — Row Level Security, edge functions, real-time
  subscriptions, auth integration, setup, and configuration. Use when working with
  supabase patterns.
domain: development
author: oyi77
license: Apache-2.0
