...
Mindset skill for active listening. Builds capability through deliberate practice and structured frameworks.
...
1. **Execute** — Run active listening workflow with configured parameters
