...
description: Use when map, engage, and align stakeholders using the power-interest
  grid, RACI matrix, and communication plans. Use when navigating complex projects
  or organizational politics. Use when working with stakeholder management.
domain: mindset
author: oyi77
license: Apache-2.0
subdomain: mindset
...
- **Start small** — Begin with manageable stakeholder management practices and build incrementally
...
1. **Morning intention** — Set a specific stakeholder management goal for the day
2. **Active practice** — Apply stakeholder management techniques during real situations
3. **Evening reflection** — Review the day's stakeholder management moments and lessons learned
4. **Journal entry** — Record insights, wins, and areas for improvement

## Frameworks

- **OODA Loop** — Observe, Orient, Decide, Act — for rapid stakeholder management decision cycles
- **PDCA Cycle** — Plan, Do, Check, Act — for iterative stakeholder management improvement
- **After-Action Review** — What happened? Why? What to improve?
- **Deliberate Practice** — Focused effort on specific stakeholder management weaknesses
...
- Keep a stakeholder management journal for tracking progress
