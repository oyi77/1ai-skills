...
Mindset skill for resilience. Builds capability through deliberate practice and structured frameworks.
...
- **Start small** — Begin with manageable resilience practices and build incrementally
...
1. **Morning intention** — Set a specific resilience goal for the day
2. **Active practice** — Apply resilience techniques during real situations
3. **Evening reflection** — Review the day's resilience moments and lessons learned
4. **Journal entry** — Record insights, wins, and areas for improvement

## Frameworks

- **OODA Loop** — Observe, Orient, Decide, Act — for rapid resilience decision cycles
- **PDCA Cycle** — Plan, Do, Check, Act — for iterative resilience improvement
- **After-Action Review** — What happened? Why? What to improve?
- **Deliberate Practice** — Focused effort on specific resilience weaknesses
...
- Keep a resilience journal for tracking progress
- Find an accountability partner or mentor
- Set weekly resilience challenges with measurable outcomes
...
1. **Execute** — Run resilience workflow with configured parameters
