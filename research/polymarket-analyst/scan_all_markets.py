...
class MarketCategorizer:
    ...
    CATEGORIES = {
        'Politics': ['trump', 'biden', 'ukraine', 'russia', 'election', 'vote', 'democrat', 'republican', 
                     'congress', 'senate', 'president', 'cabinet', 'nomination', 'nominee', 'primary',
                     'governor', 'mayor', 'clinton', 'yang', 'omar', 'politics', 'deport', 'immigration'],
        'Sports': ['nba', 'epl', 'premier', 'football', 'soccer', 'baseball', 'nfl', 'nhl', 'mlb',
                   'arsenal', 'chelsea', 'manchester', 'liverpool', 'city', 'united', 'leeds',
                   'basketball', 'tennis', 'golf', 'mma', 'boxing', 'ufc', 'olympics', 'fifa',
                   'lebron', 'curry', 'pacers', 'ncaa', 'march', 'madness', 'sun devils', 'wolf pack'],
        'Crypto': ['bitcoin', 'btc', 'ethereum', 'eth', 'crypto', 'token', 'blockchain', 'defi',
                   'nft', 'altcoin', 'mining', 'bull', 'bear', 'marketcap', 'satoshi'],
        'Entertainment': ['gta', 'vi', 'grand theft', 'game', 'gaming', 'movie', 'film', 'oscar',
                          'emmy', 'grammy', 'award', 'netflix', 'disney', 'spotify', 'stream',
                          'taylor', 'swift', 'kanye', 'drake', 'music', 'album', 'jesus', 'bible'],
        'Tech': ['ai', 'artificial', 'openai', 'chatgpt', 'google', 'microsoft', 'apple', 'tesla',
                 'elon', 'musk', 'twitter', 'x.com', 'spacex', 'tech'],
        'Economy': ['recession', 'inflation', 'fed', 'interest', 'rate', 'gdp', 'economy', 'market',
                    'stock', 'nasdaq', 'dow', 'snp', 'finance', 'bank', 'debt'],
        'Science': ['space', 'nasa', 'mars', 'moon', 'rocket', 'launch', 'climate', 'temperature'],
        'Other': []
    }
...
def print_report(analysis: Dict):
    ...
    print("-"*70)
    for cat, markets in sorted(categories.items(), key=lambda x: len(x[1]), reverse=True):
