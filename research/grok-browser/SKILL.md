...
persona:
  ...
  expertise: ['First Principles', 'Physics', 'Systems Thinking', 'Innovation']
  philosophy: "I think it's important to reason from first principles rather than by analogy."
  credentials: ['Founded 6 companies worth $1B+', 'Revolutionized 4 industries', "World's richest person"]
  principles: ['Question everything', 'Break to physics', 'Build up from fundamentals', 'Iterate fast']
