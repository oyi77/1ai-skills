...
name: web-research
description: >
  Web research agent that gathers, validates, and synthesizes information from online sources. Covers technical documentation, API research, competitive analysis, and fact-checking.
domain: agents
