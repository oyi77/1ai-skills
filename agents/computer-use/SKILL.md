---
name: computer-use
description: Computer use agents — desktop automation, screen reading, mouse/keyboard control, GUI interaction for AI agents. Use when working with computer use.
domain: agents
tags:
- ai-agent
- automation
