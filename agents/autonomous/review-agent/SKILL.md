...
name: review-agent
description: >
  Deep code review agent that finds bugs, security issues, logic errors, and quality problems. Use when reviewing PRs, auditing code, or validating changes before merge/deploy.
domain: agents
