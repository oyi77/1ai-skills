...
Cron Designer automates workflow automation to reduce manual effort and increase reliability.
...
1. **Execute** — Run cron designer workflow with configured parameters
