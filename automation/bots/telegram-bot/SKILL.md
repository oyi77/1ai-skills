---
name: telegram-bot
description: Telegram bot patterns for message handling and webhook integrations. Use when working with telegram bot.
domain: automation
tags:
- automation
- bot
...
Telegram Bot automates workflow automation to reduce manual effort and increase reliability.
...
1. **Execute** — Run telegram bot workflow with configured parameters
