---
name: twitter-bot
description: Twitter Bot. Use when working with twitter bot in automation domain.
domain: automation
tags:
- automation
- bot
...
Twitter Bot automates workflow automation to reduce manual effort and increase reliability.
...
1. **Execute** — Run twitter bot workflow with configured parameters
