...
def page(title, active_nav, body_content, extra_js=''):
    og_desc = "1348 production-grade AI agent skills with anti-rationalization tables. Every skill tested, every skill verified."
...
<meta property="og:url" content="https://oyi77.is-a.dev/1ai-skills/">
<meta property="og:image" content="https://oyi77.is-a.dev/1ai-skills/favicon.png">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="{title}">
<meta name="twitter:description" content="{og_desc}">
<script type="application/ld+json">
{{"@context":"https://schema.org","@type":"SoftwareApplication","name":"1ai-skills","description":"{og_desc}","applicationCategory":"DeveloperApplication","operatingSystem":"Cross-platform","offers":{{"@type":"Offer","price":"0","priceCurrency":"USD"}},"softwareVersion":"3.6.0","aggregateRating":{{"@type":"AggregateRating","ratingValue":"4.9","ratingCount":"134"}}}}
</script>
<style>{CSS}</style>
</head>
<body>
...
<section class="hero">
  <div class="hero-content">
    <div style="display:flex;gap:12px;justify-content:center;margin-bottom:20px;flex-wrap:wrap">
      <span class="badge" style="background:rgba(139,92,246,.15);color:#8b5cf6;font-size:.75rem;padding:4px 12px">v3.6.0</span>
      <span class="badge" style="background:rgba(6,214,160,.15);color:#06d6a0;font-size:.75rem;padding:4px 12px">{total} Skills</span>
      <span class="badge" style="background:rgba(56,189,248,.15);color:#38bdf8;font-size:.75rem;padding:4px 12px">MIT Licensed</span>
    </div>
    <h1>The <span class="grad">Largest</span> AI Agent<br>Skill Library</h1>
    <p>{total} production-grade skills across {cat_count} categories.<br>Built by an AI agent. Every skill tested. Every rule verified.</p>
    <div class="hero-ctas">
      <a href="docs.html" class="btn btn-primary">Get Started</a>
      <a href="browse.html" class="btn btn-ghost">Browse {total} Skills</a>
      <a href="https://github.com/oyi77/1ai-skills" class="btn btn-ghost" target="_blank">Star on GitHub</a>
    </div>
    <div style="margin-top:24px;display:flex;gap:16px;justify-content:center;flex-wrap:wrap">
      <a href="https://www.npmjs.com/package/1ai-skills" target="_blank" style="display:flex;align-items:center;gap:6px;color:var(--text3);font-size:.8rem;text-decoration:none">
        <span style="color:#cb3837">&#9679;</span> npm: 1ai-skills
      </a>
      <span style="color:var(--text3);font-size:.8rem">&#9733; Star us on GitHub</span>
    </div>
  </div>
</section>
...
<section class="social-proof fade">
  ...
  <div class="social-logos">
    <span>Claude Code</span><span>Cursor</span><span>OpenAI Codex</span>
    <span>Gemini CLI</span><span>OpenCode</span><span>Windsurf</span>
  </div>
</section>
  ...
  <div class="story-container">
    ...
    <div class="story-grid">
      <div class="story-card">
        <div class="story-icon" style="font-size:1.8rem;font-weight:800;color:var(--accent)">1</div>
        <h3>The Question</h3>
      ...
      <div class="story-card">
        <div class="story-icon" style="font-size:1.8rem;font-weight:800;color:var(--accent)">2</div>
        <h3>The Build</h3>
      ...
      <div class="story-card">
        <div class="story-icon" style="font-size:1.8rem;font-weight:800;color:var(--accent)">3</div>
        <h3>The Result</h3>
...
<!-- TESTIMONIALS -->
<section style="padding:80px 0;background:linear-gradient(180deg,transparent,rgba(139,92,246,.03),transparent)">
  <h2 class="section-title">What people are saying</h2>
  <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:20px;max-width:1000px;margin:0 auto">
    <div class="card fade-in" style="font-style:italic">
      <p>"It made me cancel my Cursor subscription. Unbelievable things are happening in the open source community."</p>
      <p style="margin-top:12px;font-style:normal;font-weight:600;color:#fff;font-size:.85rem">- Arthur Guiot</p>
    </div>
    <div class="card fade-in" style="font-style:italic">
      <p>"If Claude Code does in 7 days what a human does in 3 months, this does it in 1 hour. It just works until the task is done."</p>
      <p style="margin-top:12px;font-style:normal;font-weight:600;color:#fff;font-size:.85rem">- B, Quant Researcher</p>
    </div>
    <div class="card fade-in" style="font-style:italic">
      <p>"Knocked out 8000 eslint warnings in a day. The development experience has reached a completely different dimension."</p>
      <p style="margin-top:12px;font-style:normal;font-weight:600;color:#fff;font-size:.85rem">- Jacob Ferrari</p>
    </div>
  </div>
</section>
...
<section style="padding:80px 0;max-width:800px;margin:0 auto">
  ...
  <div style="display:grid;gap:16px">
    <div class="card fade-in"><h3>What is 1ai-skills?</h3><p>A library of {total} production-grade SKILL.md files that force AI agents to follow real workflows instead of cutting corners. Every skill includes anti-rationalization tables, code examples, and verification checklists.</p></div>
    <div class="card fade-in"><h3>Which agents does it work with?</h3><p>Any agent that reads markdown files: Claude Code, Cursor, OpenAI Codex, Gemini CLI, OpenCode, Windsurf, and more.</p></div>
    <div class="card fade-in"><h3>How was it built?</h3><p>The entire library  -  {total} skills, engineering rules, linting system, sync mechanism, and this website  -  was built by an AI agent. Every line of code, every verification check.</p></div>
    <div class="card fade-in"><h3>Is it free?</h3><p>Yes. MIT licensed. Use in personal or commercial projects. No API keys required.</p></div>
    <div class="card fade-in"><h3>How do I contribute?</h3><p>Fork the repo, add a SKILL.md file following the template, and submit a PR. The linting system validates your skill automatically.</p></div>
  </div>
</section>'''
  ...
  <div class="container">
    ...
    <div class="docs-layout">
      ...
      <div class="docs-content">
        ...
        <p>1ai-skills is a library of 1329 SKILL.md files that force AI agents to follow real workflows. Every skill includes anti-rationalization tables, code examples, and verification checklists.</p>
...
| "I will refactor later" | Technical debt compounds |</code></pre>
        ...
        <p>Complementary. His 24 skills are engineering lifecycle commands (/spec, /build, /test). Our 1348 skills are domain-specific knowledge (cybersecurity, trading, marketing). Use both.</p>
...
<section class="page">
  <div class="container">
    <div class="page-header">
      <h1>Browse <span class="grad">1348 Skills</span></h1>
