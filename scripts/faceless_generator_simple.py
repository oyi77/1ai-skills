#!/usr/bin/env python3
"""
Faceless Short Video Generator - Simple Version
"""
...
def get_faceless_script(product_key, content_type):
    """Get faceless video script"""
...
Solusi: AI Content Pro - Full automation.
Ide 5 menit + caption 1 menit + edit 1 menit + posting auto.
Total: 8 menit per post.

ROI: 90 jam hemat = posting 12 content/hari x 30 hari = 360 content/bulan!
...
VISUAL:
→ Text: "AI = 24x lebih cepat!" centered white bold
→ B-ROLL: Workspace setup (show person struggling vs productive)
...
4. Fokus pada kebutuhan, jangan belanja karena kejar cashback
5. Cek kalender promo sebelum belanja (pastikan kalender di HP kamu)
...
"""
        ...
        # Default
        return generate_faceless_script("guru_pintar_ai", "info_benefit", "v1")
...
def main():
    ...
    print("-" * 80)
    print(generate_faceless_script("guru_pintar_ai", "info_benefit", "v1"))
    print()
    print()
    print("✅ BELANJA DUIT BALIK - QUICK TIPS:")
    print("-" * 80)
    print(generate_faceless_script("belanja_duit_balik", "quick_tips", "v1"))
    print()
