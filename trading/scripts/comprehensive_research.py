#!/usr/bin/env python3
"""
Comprehensive Trading Research & Backtest System

- Downloads all historical data for multiple pairs
- Runs parallel backtests with multiple strategies
- Uses oh-my-opencode for strategy optimization
- Generates comprehensive reports with highest thinking
...
def run_single_backtest(cfg):
    ...
    try:
        ...
        result = subprocess.run(
            ...
            cwd="/home/openclaw/C:\\Users\\EX PC\\.openclaw\\workspace/skills/1ai-skills/trading"
        )
...
def generate_comprehensive_report(results):
    ...
    print("-" * 80)
    print(f"{'Strategy':<30} {'Tests':>7} {'Avg WR':>8} {'Avg PNL':>10}")
    print("-" * 80)
    ...
    with open("comprehensive_backtest_2025.json", "w") as f:
        json.dump(report, f, indent=2)

    print(f"\n[SAVED] Results to: comprehensive_backtest_2025.json")
