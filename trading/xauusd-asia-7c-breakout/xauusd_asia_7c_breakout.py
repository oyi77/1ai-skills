...
class Asia7CBreakout:
    ...
    def run_backtest(self, start_date, end_date):
                    ...
                    trades.append(
                        {
                            ...
                            "pnl": pnl,
                            "pnl_usd": round(
                                pnl * self.config["pip_value"] * 10, 2
                            ),  # Convert to USD
                        }
                    )
                    bought = True
        ...
        profit_factor_usd = (
            gross_profit_usd / gross_loss_usd if gross_loss_usd > 0 else 0
        )
    ...
    if len(sys.argv) > 1:
        ...
        if command == "signal":
            ...
            if len(sys.argv) >= 4:
                ...
                print(
                    "Usage: python xauusd_asia_7c_breakout.py backtest 2024-01-01 2024-12-31"
                )
        else:
