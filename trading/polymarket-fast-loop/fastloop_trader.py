...
def get_binance_us_momentum(symbol="BTCUSDT", lookback_minutes=5):
...
def get_coingecko_momentum(asset="BTC"):
    ...
    try:
        ...
        price_then = price_now / (1 + change_24h / 100) if change_24h else price_now
        return {
            "momentum_pct": momentum_pct,
            "direction": "up" if momentum_pct > 0 else "down",
            "price_now": price_now,
