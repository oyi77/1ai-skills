...
class BreakoutTemplate(StrategyTemplate):
    ...
    def entry_conditions(
        ...
        Entry signals:
        - Bullish: Price breaks above HH with volume confirmation
        - Bearish: Price breaks below LL with volume confirmation
        """
    ...
    def exit_conditions(
        ...
        - Price returns to range (false breakout)
        """
        if current_idx < 1:
            return False, None
    ...
    def get_required_candles(self) -> int:
        ...
        return self.lookback_period + 14  # ATR period
